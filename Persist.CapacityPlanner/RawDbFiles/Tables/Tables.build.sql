...
IF OBJECT_ID(N'[dbo].[Allocation]', N'U') IS NOT NULL DROP TABLE [dbo].[Allocation];
IF OBJECT_ID(N'[dbo].[Capacity]', N'U') IS NOT NULL DROP TABLE [dbo].[Capacity];
IF OBJECT_ID(N'[dbo].[DemandSkill]', N'U') IS NOT NULL DROP TABLE [dbo].[DemandSkill];
IF OBJECT_ID(N'[dbo].[Demand]', N'U') IS NOT NULL DROP TABLE [dbo].[Demand];
IF OBJECT_ID(N'[dbo].[Workstream]', N'U') IS NOT NULL DROP TABLE [dbo].[Workstream];
IF OBJECT_ID(N'[dbo].[Implementation]', N'U') IS NOT NULL DROP TABLE [dbo].[Implementation];
IF OBJECT_ID(N'[dbo].[Module]', N'U') IS NOT NULL DROP TABLE [dbo].[Module];
IF OBJECT_ID(N'[dbo].[Platform]', N'U') IS NOT NULL DROP TABLE [dbo].[Platform];
IF OBJECT_ID(N'[dbo].[PersonSkill]', N'U') IS NOT NULL DROP TABLE [dbo].[PersonSkill];
IF OBJECT_ID(N'[dbo].[Person]', N'U') IS NOT NULL DROP TABLE [dbo].[Person];
IF OBJECT_ID(N'[dbo].[ImplementationTemplatePhaseDemandSkill]', N'U') IS NOT NULL DROP TABLE [dbo].[ImplementationTemplatePhaseDemandSkill];
IF OBJECT_ID(N'[dbo].[ImplementationTemplatePhaseDemand]', N'U') IS NOT NULL DROP TABLE [dbo].[ImplementationTemplatePhaseDemand];
IF OBJECT_ID(N'[dbo].[ImplementationTemplatePhase]', N'U') IS NOT NULL DROP TABLE [dbo].[ImplementationTemplatePhase];
IF OBJECT_ID(N'[dbo].[ImplementationTemplate]', N'U') IS NOT NULL DROP TABLE [dbo].[ImplementationTemplate];
IF OBJECT_ID(N'[dbo].[Lookup_AllocationType]', N'U') IS NOT NULL DROP TABLE [dbo].[Lookup_AllocationType];
IF OBJECT_ID(N'[dbo].[Lookup_EmploymentType]', N'U') IS NOT NULL DROP TABLE [dbo].[Lookup_EmploymentType];
IF OBJECT_ID(N'[dbo].[Lookup_ImplementationCategory]', N'U') IS NOT NULL DROP TABLE [dbo].[Lookup_ImplementationCategory];
IF OBJECT_ID(N'[dbo].[Lookup_Status]', N'U') IS NOT NULL DROP TABLE [dbo].[Lookup_Status];
IF OBJECT_ID(N'[dbo].[Lookup_WorkstreamCategory]', N'U') IS NOT NULL DROP TABLE [dbo].[Lookup_WorkstreamCategory];
IF OBJECT_ID(N'[dbo].[Skill]', N'U') IS NOT NULL DROP TABLE [dbo].[Skill];
IF OBJECT_ID(N'[dbo].[Role]', N'U') IS NOT NULL DROP TABLE [dbo].[Role];


-- Create tables in manifest order

-- ===== File: Role.ddl.sql | Table: Role =====
-- ======================================================
-- TABLE: Role
-- ======================================================
...
-- ===== File: Skill.ddl.sql | Table: Skill =====
-- ======================================================
-- TABLE: Skill
...
-- ===== File: Lookup_WorkstreamCategory.ddl.sql | Table: Lookup_WorkstreamCategory =====
-- ======================================================
...
-- ===== File: Lookup_Status.ddl.sql | Table: Lookup_Status =====
-- ======================================================
-- LOOKUP: Status
-- ======================================================
...
-- ===== File: Lookup_ImplementationCategory.ddl.sql | Table: Lookup_ImplementationCategory =====
-- ======================================================
...
-- ===== File: Lookup_EmploymentType.ddl.sql | Table: Lookup_EmploymentType =====
-- ======================================================
...
-- ===== File: Lookup_AllocationType.ddl.sql | Table: Lookup_AllocationType =====
-- ======================================================
...
-- ===== File: ImplementationTemplate.ddl.sql | Table: ImplementationTemplate =====
-- ======================================================
...
-- ===== File: ImplementationTemplatePhase.ddl.sql | Table: ImplementationTemplatePhase =====
-- ======================================================
...
-- ===== File: ImplementationTemplatePhaseDemand.ddl.sql | Table: ImplementationTemplatePhaseDemand =====
-- ======================================================
...
-- ===== File: ImplementationTemplatePhaseDemandSkill.ddl.sql | Table: ImplementationTemplatePhaseDemandSkill =====
-- ======================================================
...
-- ===== File: Person.ddl.sql | Table: Person =====
-- ======================================================
-- TABLE: Person
-- ======================================================
...
-- ===== File: PersonSkill.ddl.sql | Table: PersonSkill =====
-- ======================================================
-- TABLE: PersonSkill
-- ======================================================
...
-- ===== File: Platform.ddl.sql | Table: Platform =====
-- ======================================================
-- TABLE: Platform
-- ======================================================
...
-- ===== File: Module.ddl.sql | Table: Module =====
-- ======================================================
-- TABLE: Module
-- ======================================================
...
-- ===== File: Implementation.ddl.sql | Table: Implementation =====
-- ======================================================
...
-- ===== File: Workstream.ddl.sql | Table: Workstream =====
-- ======================================================
-- TABLE: Workstream
-- ======================================================
...
-- ===== File: Demand.ddl.sql | Table: Demand =====
-- ======================================================
-- TABLE: Demand
-- ======================================================
...
-- ===== File: DemandSkill.ddl.sql | Table: DemandSkill =====
-- ======================================================
-- TABLE: DemandSkill
-- ======================================================
...
-- ===== File: Capacity.ddl.sql | Table: Capacity =====
-- ======================================================
-- TABLE: Capacity
-- ======================================================
...
-- ===== File: Allocation.ddl.sql | Table: Allocation =====
-- ======================================================
-- TABLE: Allocation
-- ======================================================
...
-- ===== File: Actual.ddl.sql | Table: Actual =====
-- ======================================================
-- TABLE: Actual
-- ======================================================
...
-- ===== File: Scenario.ddl.sql | Table: Scenario =====
-- ======================================================
-- TABLE: Scenario
-- ======================================================
...
-- ===== File: ForecastResult.ddl.sql | Table: ForecastResult =====
-- ======================================================
